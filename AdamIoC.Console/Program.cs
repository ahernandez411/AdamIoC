using AdamIoC.Console.Implementations;
...
namespace AdamIoC.Console
{
    class Program
    {
        /*
            ...
            3   The container must be aware and control object lifecycle for transient objects 
            ...
            6   If you try to resolve a type that the container is unaware of it should throw 
                an informative exception
            
            7   When resolving from the container for a registered type, if that type has constructor
            ...
            9   You must use git for source control and push your code to github.com. Please send me the link 
